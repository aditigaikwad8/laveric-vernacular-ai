 ...
 */
export const handleCloudonixTransferResultApiV1TelephonyCloudonixTransferResultTransferIdPost = <ThrowOnError extends boolean = false>(options: Options<HandleCloudonixTransferResultApiV1TelephonyCloudonixTransferResultTransferIdPostData, ThrowOnError>) => (options.client ?? client).post<HandleCloudonixTransferResultApiV1TelephonyCloudonixTransferResultTransferIdPostResponses, HandleCloudonixTransferResultApiV1TelephonyCloudonixTransferResultTransferIdPostErrors, ThrowOnError>({ url: '/api/v1/telephony/cloudonix/transfer-result/{transfer_id}', ...options });
 ...
 */
export const endTextChatSessionApiV1WorkflowWorkflowIdTextChatSessionsRunIdEndPost = <ThrowOnError extends boolean = false>(options: Options<EndTextChatSessionApiV1WorkflowWorkflowIdTextChatSessionsRunIdEndPostData, ThrowOnError>) => (options.client ?? client).post<EndTextChatSessionApiV1WorkflowWorkflowIdTextChatSessionsRunIdEndPostResponses, EndTextChatSessionApiV1WorkflowWorkflowIdTextChatSessionsRunIdEndPostErrors, ThrowOnError>({
 ...
 */
export const testToolApiV1ToolsToolUuidTestPost = <ThrowOnError extends boolean = false>(options: Options<TestToolApiV1ToolsToolUuidTestPostData, ThrowOnError>) => (options.client ?? client).post<TestToolApiV1ToolsToolUuidTestPostResponses, TestToolApiV1ToolsToolUuidTestPostErrors, ThrowOnError>({
 ...
 */
export const getDispositionCodesApiV1OrganizationsDispositionCodesGet = <ThrowOnError extends boolean = false>(options?: Options<GetDispositionCodesApiV1OrganizationsDispositionCodesGetData, ThrowOnError>) => (options?.client ?? client).get<GetDispositionCodesApiV1OrganizationsDispositionCodesGetResponses, GetDispositionCodesApiV1OrganizationsDispositionCodesGetErrors, ThrowOnError>({ url: '/api/v1/organizations/disposition-codes', ...options });
 ...
 */
export const optionsPublicChatSessionApiV1PublicEmbedChatSessionTokenOptions = <ThrowOnError extends boolean = false>(options: Options<OptionsPublicChatSessionApiV1PublicEmbedChatSessionTokenOptionsData, ThrowOnError>) => (options.client ?? client).options<OptionsPublicChatSessionApiV1PublicEmbedChatSessionTokenOptionsResponses, OptionsPublicChatSessionApiV1PublicEmbedChatSessionTokenOptionsErrors, ThrowOnError>({ url: '/api/v1/public/embed/chat/{session_token}', ...options });
 ...
 * Fallback OPTIONS handler; browser preflights hit PublicEmbedCORSMiddleware.
 */
export const optionsPublicChatEndApiV1PublicEmbedChatSessionTokenEndOptions = <ThrowOnError extends boolean = false>(options: Options<OptionsPublicChatEndApiV1PublicEmbedChatSessionTokenEndOptionsData, ThrowOnError>) => (options.client ?? client).options<OptionsPublicChatEndApiV1PublicEmbedChatSessionTokenEndOptionsResponses, OptionsPublicChatEndApiV1PublicEmbedChatSessionTokenEndOptionsErrors, ThrowOnError>({ url: '/api/v1/public/embed/chat/{session_token}/end', ...options });
 ...
 * Fallback OPTIONS handler; browser preflights hit PublicEmbedCORSMiddleware.
 */
export const optionsPublicChatMessagesApiV1PublicEmbedChatSessionTokenMessagesOptions = <ThrowOnError extends boolean = false>(options: Options<OptionsPublicChatMessagesApiV1PublicEmbedChatSessionTokenMessagesOptionsData, ThrowOnError>) => (options.client ?? client).options<OptionsPublicChatMessagesApiV1PublicEmbedChatSessionTokenMessagesOptionsResponses, OptionsPublicChatMessagesApiV1PublicEmbedChatSessionTokenMessagesOptionsErrors, ThrowOnError>({ url: '/api/v1/public/embed/chat/{session_token}/messages', ...options });

/**
 * Post Public Chat Message
 */
export const postPublicChatMessageApiV1PublicEmbedChatSessionTokenMessagesPost = <ThrowOnError extends boolean = false>(options: Options<PostPublicChatMessageApiV1PublicEmbedChatSessionTokenMessagesPostData, ThrowOnError>) => (options.client ?? client).post<PostPublicChatMessageApiV1PublicEmbedChatSessionTokenMessagesPostResponses, PostPublicChatMessageApiV1PublicEmbedChatSessionTokenMessagesPostErrors, ThrowOnError>({
